...
const keystoreDir = '/home/node4/SYT/Node2-SYT/key/keystore';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=/home/node4/SYT/Node2-SYT/config/configNode2.toml --node-private-key-file="${tempPrivateKeyFilePath}"`;
