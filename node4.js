...
const account = '0x12cbcadf73d9fe92d7232379e161482f19ba4b1c';
const keystoreDir = '/home/node4/SYT/Node4-SYT/key/keystore';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=/home/node4/SYT/Node4-SYT/config/configNode4.toml --node-private-key-file="${tempPrivateKeyFilePath}"`;
